        ...
        <b-card title="Iniciar sesion">
            <b-form @submit.stop.prevent="starsession">
                <b-form-group id="input-group-1" label="Correo electronico:" label-for="input-1">
                    <b-form-input v-model="usuario.email" id="input-1" type="email" placeholder="correo" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="input-group-2" label="Contraseña:" label-for="input-2">
                    <b-form-input v-model="usuario.pass" id="input-2" type="password" placeholder="contraseña" required>
                    </b-form-input>
                    <div>
        ...
        <b-card title="Registro de nuevo paciente">
            <b-form @submit.stop.prevent="onSubmit">
                <b-form-group id="register-group-1" label="Nombre:" label-for="register-1">
                    <b-form-input v-model="pacin" id="register-1" type="text" placeholder="Ingresa tu nombre(s)" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-2" label="Apellidos:" label-for="register-2">
                    <b-form-input v-model="paciln" id="register-2" type="text" placeholder="Ingresa tus apellidos" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-12" label="Correo:" label-for="register-12">
                    <b-form-input v-model="paciem" id="register-12" type="email" placeholder="Ingresa un correo" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-3" label="Edad:" label-for="register-3">
                    <b-form-input v-model="paciag" id="register-3" type="number" placeholder="" required>
                    </b-form-input>
                </b-form-group>
                ...
                <b-form-group id="register-group-6" label="Proposito:" label-for="register-6">
                    <b-form-input v-model="pacip" id="register-6" type="text" placeholder="¿Cual es tu proposito?" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-7" label="Imagen de perfil:" label-for="register-7">
                    <b-form-file v-model="pacif" :state="Boolean(pacif)" accept="image/*" id="register-7" placeholder="Selecciona o arrastra      " drop-placeholder="Arrastra o selecciona">
                    </b-form-file>
                </b-form-group>
                <b-form-group id="register-group-8" label="Responsable:" label-for="register-8">
                    <b-form-select v-model="pacips" class="form-control" id="register-8" required>
                        <template #first>
                            <b-form-select-option :value="null" disabled>Seleccione</b-form-select-option>
                            <b-form-select-option v-for="(psicologo, index) in list" :value="psicologo.nombre_usuario" v-bind:key="index">{{ psicologo.nombre}} {{psicologo.apellidos}}</b-form-select-option>
                        </template>
                    </b-form-select>
                </b-form-group>
                <b-form-group id="register-group-9" label="Nombre de usuario:" label-for="register-9">
                    <b-form-input v-model="paciun" id="register-9" type="text" placeholder="Ingrese su nombre de usuario" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-10" label="Contraseña:" label-for="register-10">
                    <b-form-input v-model="pacipass" id="register-10" type="password" placeholder="Ingrese una contraseña" required>
                    </b-form-input>
                </b-form-group>
                <b-form-group id="register-group-11" label="Repita contraseña" label-for="register-11">
                    <b-form-input v-model="pacipassv" id="register-11" type="password" placeholder="" required>
                    </b-form-input>
                </b-form-group>
...
export default {
    ...
    async    onSubmit() {
            if (this.pacipass == this.pacipassv) {
                ...
                const formData = new FormData();
                formData.append( 'userpic', this.pacif);
                this.pacireg.foto = [...formData.entries()]
                console.log("La foto tiene")
                console.log(this.pacireg.foto[1])
