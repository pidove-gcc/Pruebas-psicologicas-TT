  ...
  <div class="container">
    <div v-if="option" align="center" class="mt-5 border border-primary">
      <b-card title="Iniciar sesion">
        ...
        <b-button @click="starsession('invitado')"
          >Ingresar como invitado</b-button
        >
        <b-button @click="selectUser">link BD</b-button>
      </b-card>
    </div>
          ...
          >
            <b-form-select class="form-control" id="register-8" required>
              <template #first>
                ...
                >
                <b-form-select-option
                  v-for="(psicologo, index) in psicologos"
                  :value="psicologo.name"
                  v-bind:key="index"
                  >{{ psicologo.name }}</b-form-select-option
                >
              </template>
            </b-form-select>
          </b-form-group>
